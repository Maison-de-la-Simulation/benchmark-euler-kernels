...
void EulerSimulationOpti(benchmark::State& state)
{
    real_t const cfl_factor = 0.49;
    real_t const gamma = 1.4;
...
BENCHMARK(EulerSimulationOpti)
        ->Name("EulerSimulationOptiStrong")
        ->UseRealTime()
        ->Arg(128)
        ->Arg(256)
        ->Arg(384);
BENCHMARK(EulerSimulationVectorized)
        ->Name("EulerSimulationVectorizedStrong")
        ->UseRealTime()
        ->Arg(128)
        ->Arg(256)
        ->Arg(384);
